...
function scm_uninstall() {
	...
	scm_remove_generated_directory();
}
...
/**
 * Remove all files generated by Cache Master.
 *
 * @return void
 */
function scm_remove_generated_directory()
{
	$dir = WP_CONTENT_DIR . '/uploads/' . SCM_PLUGIN_TEXT_DOMAIN;
