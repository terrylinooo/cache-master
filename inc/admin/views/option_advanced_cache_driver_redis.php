		...
		<div class="scm-option-item">
			...
			<div class="scm-option-item">
				...
				<input 
					...
					value="<?php esc_attr( $redis_field_value ); ?>" 
				/>
			</div>
			<?php endforeach; ?>
		</div>
		...
		<div class="scm-option-item">
			...
			<span>
				...
				<label>
					<?php _e( 'Unix Socket', 'cache-master' ); ?>
				<label>
				<input type="hidden" name="scm_option_advanced_driver_redis_connection_type" value="<?php esc_attr( $option_redis_connection_type ); ?>">
			</span>
		</div><br /><br />
