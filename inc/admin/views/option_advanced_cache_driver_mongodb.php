        ...
        <div>
            ...
            <div class="scm-option-item">
                ...
                <input 
                    ...
                    value="<?php esc_attr_e( $mongodb_field_value ); ?>" 
                />
            </div>
            <?php endforeach; ?>
            ...
            <div class="scm-option-item">
                ...
                <span>
                    ...
                    <label>
                        <?php _e( 'Unix Socket', 'cache-master' ); ?>
                    <label>
                    <input type="hidden" name="scm_option_advanced_driver_mongodb_connection_type" value="<?php esc_attr_e( $option_mongodb_connection_type ); ?>">
                </span>
            </div><br /><br />
