	...
	<div class="shieldon-author">
		<p class="created-by">
			...
			printf(
				...
				__( 'Cache Master is brought to you by <a href="%1$s">Terry L.</a> from <a href="%2$s">Taiwan</a>.', 'cache-master' ),
				'https://terryl.in',
				'https://www.google.com/maps/@23.4722181,120.9910232,8z'
			);
			?>
		</p>
		...
		<p><?php _e( 'If you have any issues or have found any bugs, please report them at the following URL.', 'cache-master' ); ?></p>
