...
<div>
	<div class="scm-option-item">
        ...
        <div class="scm-option-example">
            ...
            <img src="<?php echo SCM_PLUGIN_URL; ?>inc/assets/images/sample-benchmark-widget-1.png">
        </div>
	</div>
	<div class="scm-option-item">
		<div>
        ...
        <div class="scm-option-example">
			<?php _e( 'Example', 'cache-master' ); ?><br />
            <img src="<?php echo SCM_PLUGIN_URL; ?>inc/assets/images/sample-benchmark-widget-2.png">
        </div>
	</div>
	<div class="scm-option-item">
		<div>
        ...
        <div class="scm-option-example">
			<?php _e( 'Example', 'cache-master' ); ?><br />
            <img src="<?php echo SCM_PLUGIN_URL; ?>inc/assets/images/sample-benchmark-widget-3.png">
        </div>
	</div>	
</div>
